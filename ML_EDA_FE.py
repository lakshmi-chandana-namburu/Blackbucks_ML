...
X_test = titanic2[tt.shape[0]:] #shape[0]: means 0 index to n index. Not specifying end index is nothing but till nth index
X_test.shape
X_test.info()
ttest['Survived'] = param_grid.predict(X_test)
tt.to_csv(r"D:\20_594\blackbucks_level2\Attempt5.csv", columns=['PassengerId','Survived'],index=False)
